...
import GradientDescentIntroduction2D from '../../components/gradient_descent/GradientDescentIntroduction2D';

// description(<String>, <Function>) method is a way to group bunch of test which fit under the same suite case
describe('Gradient Descent 2D Introduction Rendering', () => {

    it("Should have header with 'Gradient descent 1D' as value", () => {
        let { getByTestId } = render(<GradientDescentIntroduction2D/>);
